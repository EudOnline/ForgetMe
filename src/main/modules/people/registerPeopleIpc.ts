...
import {
  ...
  journalIdSchema,
  personProfileAttributeFilterSchema,
  profileAttributeCandidateFilterSchema,
  queueItemIdSchema,
...
export function registerPeopleIpc(appPaths: AppPaths) {
  ...
  ipcMain.handle('archive:selectContextPackExportDestination', async () => {
    return selectDirectory('FORGETME_E2E_CONTEXT_PACK_DESTINATION_DIR')
  })
