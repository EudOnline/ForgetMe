    ...
    vi.stubGlobal('window', {
      archiveApi: {
        listEnrichmentJobs: vi.fn().mockResolvedValue([
          { id: 'job-1', fileId: 'file-1', fileName: 'id-card.jpg', status: 'pending', enhancerType: 'document_ocr', provider: 'siliconflow', model: 'model-a', attemptCount: 0, errorMessage: null, startedAt: null, finishedAt: null, createdAt: '2026-03-11T00:00:00.000Z', updatedAt: '2026-03-11T00:00:00.000Z' },
