...
function installConflictCompareMocks() {
...
describe('ReviewWorkbenchPage', () => {
  ...
  it('shows conflict compare details and supports button plus keyboard navigation inside the selected group', async () => {
    const { getReviewWorkbenchItem } = installConflictCompareMocks()
  ...
  it('navigates conflict compare items without act warnings', async () => {
