...
describe('registerObjectiveIpc', () => {
  ...
  it('registers objective runtime handlers and omits obsolete run-centric handlers', async () => {
    ...
    expect(handlerMap.has('archive:getObjectiveRuntimeSnapshot')).toBe(true)
    expect(handlerMap.has('archive:getObjectiveRuntimeScorecard')).toBe(true)
    expect(handlerMap.has('archive:getObjectiveRuntimeProjectionHealth')).toBe(true)
    expect(handlerMap.has('archive:listObjectiveRuntimeEvents')).toBe(true)
    expect(handlerMap.has('archive:listObjectiveRuntimeAlerts')).toBe(true)
    expect(handlerMap.has('archive:acknowledgeObjectiveRuntimeAlert')).toBe(true)
    expect(handlerMap.has('archive:resolveObjectiveRuntimeAlert')).toBe(true)
    expect(handlerMap.has('archive:getObjectiveRuntimeSettings')).toBe(true)
    expect(handlerMap.has('archive:updateObjectiveRuntimeSettings')).toBe(true)
